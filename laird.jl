...
Hey Laird, I put together this quick page to help share follow-up notes from our sessions. I hope that they are helpful!
"""
...
```math
\begin{align}
Y:&\quad F_\mathrm{T}\cos\theta = mg\, , \\
X:&\quad \frac{m v^2}{r + l\sin\theta} = F_\mathrm{T}\sin\theta \\
\quad\Longrightarrow&\quad
v = \sqrt{\left(r + l\sin\theta\right) g \tan\theta} \quad.
\end{align}
```
"""
...
md"""
To bring this home, all we need to do now is just relate it to the period and solve for ``P``
